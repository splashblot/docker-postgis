...
for version in "${versions[@]}"; do
	...
	(
		set -x
		cp Dockerfile.template 01-initdb-postgis.sh 02-initdb-cartodb_pgsql.sh 03-initdb-cartodb_crankshaft.sh 04-initdb-metabase.sh 05-initdb-webodm.sh README.md "$version/"
